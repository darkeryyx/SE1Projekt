...
Unpaid ohne NachzahlState, BackUp falls es irgendwelche Fehler gibt




public class UnpaidBackUp extends TTState {
    public UnpaidBackUp(ServletContext context, HashMap<Integer, Ticket> ticketIdList) {
        super(context, ((HashMap<Integer, Ticket>) context.getAttribute("TicketIDs")) );
    }

    public UnpaidBackUp(ServletContext context, HashMap<Integer, Ticket> ticketIdList, Ticket ticket) {
        super(context,  ((HashMap<Integer, Ticket>) context.getAttribute("TicketIDs")), ticket);
