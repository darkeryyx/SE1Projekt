...
public class SingleTicketPayPenalty extends TTState {

    private String message = "Das Ticket mit der ID: " + ticket.getTicketID() + " muss eine Nachzahlung leisten";

    public SingleTicketPayPenalty(ServletContext context, Ticket ticket) {
    ...
    public void handle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("PayPenaltyState");
